...
from core.config import TOKEN, ADMIN_MARSELLE, ADMIN_MARSELLE_INT
...
async def start(message: Message):
    start_photo = ["core/static/image/start2.jpg","core/static/image/start3.jpg"]
    ...
    if message.chat.id == ADMIN_MARSELLE_INT:
